    ...
    <>
      <div className="relative">
        <input
          {...register}
          type={thisType}
          style={{ paddingRight: `${name === "password" || name === "email" && "37px !important"}` }}
        ...
        {name === "email" &&
          <div className="text-[var(--color-primary)] absolute top-[50%] transform translate-y-[-50%] right-[5px] flex items-center px-2 cursor-pointer" onClick={changeType}>
            <div>{t.sendCode}</div>
          </div>
        }
      </div>
