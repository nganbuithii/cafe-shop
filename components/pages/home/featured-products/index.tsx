...
const FeaturedProducts = () => {
  ...
  return (
    <div className="w-full featured-products">
      <h2 className="title-custom mt-[23px] mb-[11px] lg:mt-[52px] lg:mb-[48px]">
        {storePageComponent.pageComponent.itemProductBest && storePageComponent.pageComponent.itemProductBest.title
          ? storePageComponent.pageComponent.itemProductBest.title
          : t.maybeYouWantToKnow}
      </h2>
      ...
      <Link href={"/product"}>
        <a className="w-fit text-primary flex items-center justify-center mx-auto lg:mt-[79px] mt-[38px] lg:text-[16px] text-[14px]">
          ...
          <span className="block w-[24px] h-[24px] relative">
            <Image src={"/images/icons/ic-arrow-right.svg"} alt="icon" objectFit="cover" priority={true} layout="fill" />
          </span>
        </a>
      </Link>
    </div>
