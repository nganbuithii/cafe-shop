    ...
    <div className="w-full bg-primary-lighter mt-[58px] lg:py-[73px] py-[32px]">
      <div className="container lg:px-[34px] px-[20px] lg:flex items-center">
        <div className="relative lg:w-[45%] lg:min-w-[45%] w-full min-w-full">
          ...
          <Image src="/images/product-img/img-map.png" alt="media" layout="fill" objectFit="cover" />
        </div>
        <div className="lg:pl-[159px] lg:mt-0 mt-[41px]">
          <div className="grid grid-cols-2 lg:gap-y-[59px] lg:gap-x-[81px] gap-y-[31px] gap-x-[36px]">
            <Item
              imageUrl="/images/icons/product-detail/ic-map.svg"
              title={t.origin}
            ...
            />
            <Item
              imageUrl="/images/icons/product-detail/ic-mountains.svg"
              title={t.elevation}
              content="1515 - 1560m"
            ...
            />
            <Item
              imageUrl="/images/icons/product-detail/ic-type.svg"
              title={t.typeOfBeans}
            ...
            />
            <Item
              imageUrl="/images/icons/product-detail/ic-repeat.svg"
