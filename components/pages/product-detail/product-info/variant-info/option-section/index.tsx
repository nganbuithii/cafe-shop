...
const OptionSection = () => {
  ...
  return (
    <div className="w-full pt-[7.5px]">
      <OptionItem
        title={storeProduct.productOptionsCustom?.options1?.label}
      ...
      />
      <OptionItem
        title={storeProduct.productOptionsCustom?.options2?.label}
      ...
      />
      <OptionItem
        title={storeProduct.productOptionsCustom?.options3?.label}
