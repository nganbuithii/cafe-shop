...
const OptionItem = ({ title = "", options = [], optionType = PRODUCT_OPTION_TYPE.TYPE1, handleOptionSelected, selectedVariant }: Props) => {
    ...
    <div className="w-full mt-[17.5px]">
      ...
      <div className="flex flex-wrap">
        {options.map((option, index) => {
          return (
            <div
              className={`${option.isDisabled ? "opacity-60 cursor-not-allowed" : "cursor-pointer"} 
