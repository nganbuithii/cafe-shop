          ...
          <div className="w-full mb-[40px] grid grid-cols-1 lg:grid-cols-2 items-center">
            ...
            <div className="flex justify-center">
              <div className="items-center flex-col h-full w-full md:w-[450px]">
                <p className="text-[30px] text-[white] sm:text-[40px] pt-[20px] text-black-300 text-center font-bold">{t.signIn}</p>
                <form className="mt-[30px] md:mt-[10px] font-['Roboto']">
                  <div className="bg-[white] relative p-[20px] border-[1px] border-[#E5E5E5] rounded-[8px]">
                    ...
                    <div className="flex justify-end mt-[12px] relative z-10">
                      <p
                        className="cursor-pointer text-[var(--color-primary)] text-[14px] sm:text-[16px] w-[max-content]"
                        onClick={() => {
                    ...
                    <p className="text-grey-300 text-[14px] sm:text-[18px] font-normal  md:my-[10px] text-center my-[10px]">{t.orLoginBySocial}</p>
                    <div className="flex justify-center">
                    ...
                    <p className="text-[14px] sm:text-[18px] mt-[20px] text-center">
                      {t.dontHaveAnAccount}?
                      <span
                        onClick={() => {
                          router.push("/register")
                        }}
                        className="mx-[5px] cursor-pointer border-b-2 border-[black] hover:border-[var(--color-primary)] hover:text-[var(--color-primary)] text-[#050226]"
                      >
                        {t.signUp}
                      </span>
                    </p>
