...
const ShoppingCart = () => {
  ...
  return (
    <div className="container">
      <Breadcrumb breadcrumb={[{ title: t["Shopping cart"], href: "/shopping-cart" }]} />
          ...
          <div className="flex flex-col ml-5 w-[32%] max-lg:ml-0 max-lg:w-full">
            <div className="flex flex-col grow px-2.5 py-5 text-slate-950 max-md:mt-0 ">
              ...
              <Link href={`/shopping-cart/payment`}>
                <a className="justify-center items-center self-center px-16 py-1.5 mt-5 w-[90%] max-w-full text-lg tracking-normal leading-7 text-center whitespace-nowrap bg-sky-600 rounded text-neutral-50 max-md:px-5">
                  Xác Nhận
                </a>
              </Link>
            </div>
